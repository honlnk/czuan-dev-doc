...
-- 插入root用户数据
INSERT INTO `users` (`id`, `uname`, `account`, `password`, `mail`, `power`, `is_disable`, `created_by`, `update_by`)
VALUES (1, 'honlnk', 'root', 'eb00f6599576b03df5f992244a062946533cac3a0928addec1da580cc8482437', 'jihongshen1@outlook.com', 2047, 0, 'root', 'root');
...
-- 插入权限数据
INSERT INTO `power` (`name`, `value`, `cn_name`)
VALUES 
('GET', 1, '允许查看'),
('COMMENT', 2, '允许评论'),
('ADD', 4, '允许新增'),
('UPDATE', 8, '允许修改'),
('DELETE', 16, '允许删除'),
('WORD_TEST', 32, '允许使用单词测试功能'),
('MANAGE_USERS', 64, '允许管理其他用户');
...
-- 插入百度配置数据
INSERT INTO `baidu_serve_info` (`api_key`, `secret_key`, `name`, `api_url`)
VALUES ('*****', '*****', '百度机器翻译-文本翻译-词典版', 'https://aip.baidubce.com/rpc/2.0/mt/texttrans-with-dict/v1');
